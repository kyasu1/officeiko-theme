<div class="f5 f3-ns fw5 bg-white pv3">
  <div class="w-90 center">
    <p class="f3 f2-ns b ma0 tc">主なお取り扱い品目</p>
    <hr />
  </div>
  <div>
      ...
      <div class="w-third relative">
        <a href="/item/watch" class="link dim">
 					<img src="@asset('images/watch.jpg')"
							 ...
							 alt="時計"
					/>
          <p class="absolute black b f6 f4-ns overlay-bottom-center shadow-white">腕 時 計</p>
        </a>
      </div>
      <div class="w-third relative">
        <a href="/item/jewelry" class="link dim">
					<img src="@asset('images/jewelry.jpg')"
							 ...
							 alt="ジュエリー"
					/>
          <p class="absolute black b f6 f4-ns overlay-bottom-center shadow-white">ジュエリー</p>
        </a>
      </div>
      <div class="w-third relative">
        <a href="/item/bag" class="link dim">
 					<img src="@asset('images/bag.jpg')"
							 ...
							 alt="ブランド品"
					/>
          <p class="absolute black b f6 f4-ns overlay-bottom-center shadow-white">ブランド品</p>
        </a>
      </div>
    </div>
  </div>
      ...
      <div class="w-third relative">
        <a href="/item/diamond" class="link dim">
 					<img src="@asset('images/diamond.jpg')"
							 ...
							 alt="ダイヤモンド"
					/>
          <p class="absolute black b f6 f4-ns overlay-bottom-center shadow-white">ダイヤモンド</p>
        </a>
      </div>
      <div class="w-third relative">
        <a href="/item/camera" class="link dim">
 					<img src="@asset('images/camera.jpg')"
							 ...
							 alt="カメラ"
					/>
          <p class="absolute black b f6 f4-ns overlay-bottom-center shadow-white">カメラ</p>
        </a>
      </div>
      <div class="w-third relative">
        <a href="/item/gadget" class="link dim">
 					<img src="@asset('images/gadget.jpg')"
							 ...
							 alt="スマホ等"
					/>
          <p class="absolute black b f6 f4-ns overlay-bottom-center shadow-white">スマホ等</p>
        </a>
      </div>
    </div>
  </div>
      ...
      <div class="w-third relative">
        <a href="/item/ticket" class="link dim">
 					<img src="@asset('images/ticket.jpg')"
							 ...
							 alt="金券・切手"
					/>
          <p class="absolute black b f6 f4-ns overlay-bottom-center shadow-white">商品券・切手</p>
        </a>
      </div>
      <div class="w-third relative">
        <a href="/item/tool" class="link dim">
 					<img src="@asset('images/tool.jpg')"
							 ...
							 alt="電動工具"
					/>
          <p class="absolute black b f6 f4-ns overlay-bottom-center shadow-white">電動工具</p>
        </a>
      </div>
      <div class="w-third relative">
        <a href="/item/golf" class="link dim">
 					<img src="@asset('images/golf.jpg')"
							 ...
							 alt="ゴルフ用品"
					/>
          <p class="absolute black b f6 f4-ns overlay-bottom-center shadow-white">ゴルフ用品</p>
        </a>
      </div>
    </div>
  </div>
